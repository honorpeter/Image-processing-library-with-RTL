...
proc update_PARAM_VALUE.AXIS_Pipeline_Length { PARAM_VALUE.AXIS_Pipeline_Length } {
	# Procedure called to update AXIS_Pipeline_Length when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.AXIS_Pipeline_Length { PARAM_VALUE.AXIS_Pipeline_Length } {
	# Procedure called to validate AXIS_Pipeline_Length
	return true
}
...
proc update_MODELPARAM_VALUE.AXIS_Pipeline_Length { MODELPARAM_VALUE.AXIS_Pipeline_Length PARAM_VALUE.AXIS_Pipeline_Length } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.AXIS_Pipeline_Length}] ${MODELPARAM_VALUE.AXIS_Pipeline_Length}
}
